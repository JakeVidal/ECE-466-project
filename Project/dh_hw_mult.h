...
SC_MODULE (dh_hw_mult)
{
  ...
  a1_adder_1.in_data_1(a1_mult); a1_adder_1.in_data_2(0x10000); a1_adder_1.out_data(a1_add_1_to_hh);
  a1_adder_2.in_data_1(a1_mux_out_1); a1_adder_2.in_data_2(0x1); a1_adder_2.out_data(a1_add_1);
